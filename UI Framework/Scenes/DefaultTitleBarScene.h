...
protected:
    std::unique_ptr<zcom::Button> _closeButton = nullptr;
    std::unique_ptr<zcom::Button> _maximizeButton = nullptr;
    std::unique_ptr<zcom::Button> _minimizeButton = nullptr;
    std::unique_ptr<zcom::Image> _iconImage = nullptr;
    std::unique_ptr<zcom::Label> _titleLabel = nullptr;
    std::vector<std::unique_ptr<zcom::Button>> _menuButtons;
